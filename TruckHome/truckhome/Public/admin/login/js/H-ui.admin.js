...
$(function(){
	...
	$(".Hui-aside").on("click",".menu_dropdown a",function(){
		if($(this).attr('_href')){
			var bStop=false;
			var bStopIndex=0;
			var _href=$(this).attr('_href')+attr('target','_blank');
			...
			if(!bStop){
				...
				iframe_box.find(".show_iframe").hide().eq(bStopIndex).show().find("iframe").attr("src",_href).attr("target","_blank");//ddddddddd
			}
		}
	});
