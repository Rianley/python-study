	...
	<link rel="stylesheet" href="/TruckHome/truckhome/Public/home/news/css/baojia.css"/>
		...
		<div style="" id="frame_left" class="frame_left">
			<div id="frame_tree" class="frame_tree fl" style="">
				...
				<div i class="pro_big_b_k"><a href="<?php echo U('Xproduct/imgindex');?>">全部</a></div>
					<?php if(is_array($tree)): $k = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div id="<?php echo ($k); ?>" class="pro_big_b"><a href="<?php echo U('Xproduct/imgindex',array('id'=>$vo['id']));?>" ><?php echo ($vo['name']); ?></a></div>
						<div id="subdiv<?php echo ($k); ?>" class="pplb1_new" style="display: none">
							<div class="pplb1newshow">
								<?php if(is_array($vo['subcat'])): $i = 0; $__LIST__ = $vo['subcat'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><div class="group1">
										<div class="newtree"> <em></em><a href="<?php echo U('Xproduct/imgindex',array('id'=>$vo1['id']));?>"><?php echo ($vo1['name']); ?></a></div>
							...
							<div id="new65" class="v_boxkih3" style="display:block">
								<div class="tpgx">
									<?php if(is_array($data9)): $i = 0; $__LIST__ = $data9;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
										<dt>
											<a target="_blank" href="<?php echo U('Xproduct/imgdetail',array('id'=>$vo['id']));?>" title="<?php echo ($vo['pname']); ?>">
											<img src="/TruckHome/truckhome/Public<?php echo ($vo['picname']); ?>" alt="<?php echo ($vo['pname']); ?>" height="160" width="240">
											</a>
										</dt>
										<dd>
											<span><a target="_blank" href="<?php echo U('Xproduct/imgdetail',array('id'=>$vo['id']));?>" alt="<?php echo ($vo['pname']); ?>" title="<?php echo ($vo['pname']); ?>"><?php echo ($vo['pname']); ?> </a></span>
										</dd>
