    ...
    <div class="es_dh">
        <div class="es_dh1">
            <ul>
                ...
                <li>
                    <a href="http://mai.360che.com/category-40.html" target="_blank">
                        安全防护
                        <span></span>
                    </a>
                </li>
                <li>
                    <a href="http://mai.360che.com/category-37.html" target="_blank">
                        底盘部件
                        <span></span>
                    </a>
                </li>
                <li>
                    <a href="http://mai.360che.com/category.php?id=71">
                        空气滤芯
                        <span></span>
                    </a>
                </li> -->
        ...
        <div class="es_dh2">
            ...
            <div class="newfloat">
                <a href="<?php echo U('Scart/index');?>" style="display:block" class="nf1" onmouseout="hiddenDiv('div_new0507')" onmouseover="showDiv('div_new0507')">我的购物车</a>
                <!-- <div class="bj0507">
                    <em class="bj_l "></em>
                    <span class="bj_m "></span>
                    <em class="bj_r "></em>
                </div> -->
            </div>
