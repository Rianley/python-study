		...
		<div class="post_list list_oneb">
			<div class="post_list_label">
				<ul>
					<li class="tab" id="upinfo1">
						<a href="" class="tab_a tab_on tabNormal" id="upinfo2" >收藏列表</a>
					</li>
			...
			<div class="post_center" id="tabpanel1">
				<div class="post_cen_label">
					<ul>
						<li class="post">
							<a href="space.php?uid=439765&amp;items=otherthreads" class="tab_a1 tab_on1 tabNormal1">全部收藏</a>
						</li>

						<li class="post_more">
							我收藏的帖子：共有
							<span style="color:#1e6cc1"><?php echo ($count); ?></span>
							个
						</li>

					</ul>
				</div>
				<?php if($col == null): ?><div style="color:red;font-size:24px;text-align:center;margin:20px" >还没有任何收藏哦！！！</div>
				<?php else: ?>

				<div class="post_wdzt" id="postpanel1">

						<?php if(is_array($col)): $i = 0; $__LIST__ = $col;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="post_wdzt_list">
							<div class="p_wdzt_la">
								...
								<div  class="p_wdzt_la2">
									<?php echo ($vo['username']); ?>
								</div>
							</div>
							<div class="p_wdzt_lb">
								<div class="p_wdzt_lb1"><?php echo date('Y-m-d H:i:s',$vo['mtime']);?><a href="<?php echo U('Lcol/cancel',array('id'=>$vo['id']));?>">取消收藏</a></div>
