	...
	<div class="prefirght">
		...
		<div class="jymx2" style="width:770px">
			...
			<div class="allin">
				...
				<div class="jymx_b_ver2">

					<div class="jymx_c_l_ver2_1" >
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr data="<?php echo ($vo['id']); ?>" >
									...
									<td class="oprate">
										...
										<div class="oprate_n">
											<a href="<?php echo U('Sorder/sordetail',array('id'=>$vo['id']));?>" target="_blank" class="act"></a>
										</div>
										...
										<a href="javascrip:;" class="del cancel">取消订单</a>
									</td>
...
<script type="text/javascript">
	$('.cancel').click(function(){
		...
		$.post("<?php echo U('Sorder/cancel');?>",{id:id},function(msg){
			if(msg=='yes'){
				$('tr[data='+id+']').remove();
			}else{
				alert('失败');
