...
<body>
	...
	<div class="jlbtiezlie">
		<div class="jlbtiezliel"><span style='color:red'>卡车之家公告</span> </div>
	</div>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<th class="subject hot">
								<span>
									<a href="<?php echo U('Lnotic/detail',array('id'=>$vo['id']));?>" target=""><?php echo ($vo['title']); ?></a>
								</span>

							</th>
							<td class="author">
								<em><?php echo date('Y-m-d H:i:s',$vo['addtime']);?></em>
							</td>
							<!-- <td class="nums"> <strong>203</strong>
								<em>52705</em>
							</td>
							<td class="lastpost">
								<cite>
								...
								<em><a href="">2016-1-11 15:57</a></em>
							</td> -->
						</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
			</table>
			<span >
				<a style="display:block;float:right;background:#4182c8;width:90px;height:30px;line-height:30px;margin-top:3px;color:#fff;font-size:14px;font-weight:bold" href="<?php echo U('Index/index');?>">&nbsp;返回首页&nbsp;</a>
			</span>
		</div>
	</div>
