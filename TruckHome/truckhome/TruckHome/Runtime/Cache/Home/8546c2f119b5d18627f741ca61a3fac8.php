	...
	<div class="prefirght">
		...
		<div class="jymx2" style="width:770px">
			...
			<div class="allin">
				...
				<?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="jymx_b_ver2" style="height:70px">
							...
							<tbody>
								<tr style="height:70px">
									...
									<td class="oprate">
										...
										<a href="<?php echo U('Sorder/sureRec',array('id'=>$vo['id']));?>" class="del" onclick="if (!confirm('您确认要确定收货吗')) return false;">确认收货</a>
