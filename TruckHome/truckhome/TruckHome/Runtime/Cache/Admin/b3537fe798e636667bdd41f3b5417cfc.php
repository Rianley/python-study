                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
										...
										<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
	                                            ...
	                                            <td style="vertical-align:middle;"><a href="<?php echo U('Xad/edit',array('id'=>$vo['id']));?>"><?php echo (msubstr($vo["title"],0,10,'utf-8',true)); ?></a></td>

                                                <td style="vertical-align:middle;"><?php echo ($vo['url']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo date('Y-m-d',$vo['atime']);?></td>
                                                <td style="vertical-align:middle;">
                                                    <img src="<?php echo ($vo['picname']); ?>" width="200px"/>
                                                </td>



	                                            <td style="vertical-align:middle;">
	                                               <a href="<?php echo U('Xad/edit',array('id'=>$vo['id']));?>" class="btn btn-primary">编辑</a>
                                                   <a href="<?php echo U('Xad/delete',array('id'=>$vo['id']));?>" class="btn btn-danger">删除</a>
