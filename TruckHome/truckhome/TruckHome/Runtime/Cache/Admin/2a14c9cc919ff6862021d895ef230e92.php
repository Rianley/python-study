                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">轮播标题1</th>
                                            <th class="text-center">链接地址1</th>
                                            <th class="text-center">添加时间</th>
                                            <th class="text-center">图片1</th>
                                    ...
                                    <tbody>
										...
										<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
	                                            ...
	                                            <td style="vertical-align:middle;"><a href="<?php echo U('Xlunbo/edit',array('id'=>$vo['id']));?>"><?php echo (msubstr($vo["title1"],0,10,'utf-8',true)); ?></a></td>

                                                <td style="vertical-align:middle;"><?php echo ($vo['url1']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo date('Y-m-d',$vo['atime']);?></td>
                                                <td style="vertical-align:middle;">
                                                    <img src="<?php echo ($vo['img1']); ?>" width="200px"/>
                                                </td>



	                                            <td style="vertical-align:middle;">
	                                               <a href="<?php echo U('Xlunbo/edit',array('id'=>$vo['id']));?>" class="btn btn-primary">编辑</a>
                                                   <a href="<?php echo U('Xlunbo/delete',array('id'=>$vo['id']));?>" class="btn btn-danger">删除</a>

	                                            </td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>

										<tr>
											<td colspan="6" class="text-center"><?php echo ($show); ?></td>
