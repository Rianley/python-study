                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <form style="border:0;">
                                            ...
                                            <th  style="border-top:0;" class="text-center" colspan="4">名牌名称:<span style="padding:0 20px;"><input type="text" value="<?php echo I('get.name');?>" name="name"/> </span><input type="submit" class="btn btn-success" value="查询"/></th>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">品牌类别名称</th>
                                    ...
                                    <tbody>
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
                                                <td style="vertical-align:middle;"><?php echo ($vo['id']); ?></td>
                                                <td style="vertical-align:middle;"><a style="margin-left:<?php echo ($vo['level']*50); ?>px;" href="<?php echo U('xarticlecate/edit',array('id'=>$vo['id']));?>">|--<?php echo ($vo['name']); ?></a></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['pid']); ?></td>


                                                <td style="vertical-align:middle;">

                                                    <a href="<?php echo U('Xbrand/add',array('id'=>$vo['id'],'name'=>$vo['name']));?>" class="btn btn-primary">添加子类</a>
                                                   <a href="<?php echo U('Xbrand/edit',array('id'=>$vo['id']));?>" class="btn btn-success">编辑</a>


                                                   <a href="<?php echo U('Xbrand/delete',array('id'=>$vo['id']));?>" class="btn btn-danger">删除</a>
