                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">车型类别名称</th>
                                            <th class="text-center">父ID</th>
                                             <th class="text-center">车型状态</th>
                                    ...
                                    <tbody>
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
                                                ...
                                                <td style="vertical-align:middle;"><a style="margin-left:<?php echo ($vo['level']*50); ?>px;" href="<?php echo U('Xcartype/edit',array('id'=>$vo['id']));?>">|--<?php echo ($vo['name']); ?></a></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['pid']); ?></td>
                                                <td style="vertical-align:middle;">
                                                <?php if($vo['tag'] == 1): ?>热门卡车
                                                <?php elseif($vo['tag'] == 2): ?>
                                                    挂车 专用车 皮卡
                                                <?php else: ?>
                                                    天然气车型<?php endif; ?>
                                                ...
                                                <td style="vertical-align:middle;">
                                                    ...
                                                    <a href="<?php echo U('Xcartype/add',array('id'=>$vo['id'],'name'=>$vo['name']));?>">添加子类</a>
                                                   <a href="<?php echo U('Xcartype/edit',array('id'=>$vo['id']));?>">编辑</a>


                                                   <a href="<?php echo U('Xcartype/delete',array('id'=>$vo['id']));?>">删除</a>
