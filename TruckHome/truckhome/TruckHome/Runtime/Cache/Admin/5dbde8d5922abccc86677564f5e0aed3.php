		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('Ltype/insert');?>" method="post">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">添加到：</label>
									<div class="col-sm-10">
										<?php if(empty($_GET['id'])): ?>顶级分类
										<?php else: ?> <?php echo I('get.catename'); endif; ?>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" class="form-control" id="catename" placeholder="类别名" name="catename">
									</div>
								</div>
