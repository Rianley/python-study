	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">修改类别</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('Ltype/update');?>"  method="post">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">类别名</label>
									<div class="col-sm-10">
										<select name="pid" id="">
											<option value="" style="text-align:center">--请选择--</option>
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php echo ($vo['id']==$data['pid'] ? 'selected' : ''); ?>  style="text-indent: <?php echo ($vo['level']*30); ?>px">|--<?php echo ($vo['catename']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">类别名</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="catename" name="catename"  value="<?php echo ($data['catename']); ?>">
