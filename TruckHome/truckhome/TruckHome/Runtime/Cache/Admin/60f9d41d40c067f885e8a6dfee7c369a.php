                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">文章类别名称</th>
                                    ...
                                    <tbody>
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
                                               ...
                                               <!--  <td style="vertical-align:middle;"><?php echo ($vo['path']); ?></td> -->

	                                            <td style="vertical-align:middle;">

                                                    <a href="<?php echo U('xarticlecate/add',array('id'=>$vo['id'],'name'=>$vo['name']));?>">添加子类</a>
                                                   <a href="<?php echo U('xarticlecate/edit',array('id'=>$vo['id']));?>">编辑</a>


                                                   <a href="<?php echo U('xarticlecate/delete',array('id'=>$vo['id']));?>">删除</a>
