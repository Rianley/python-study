		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<form action="">
					...
					浏览状态：<select name="hot" id="">
							  <option value="">请选择</option>
							  <option value="1" <?php echo I('get.hot')==1?"selected":"";?>>热帖</option>
							  <option value="2" <?php echo I('get.hot')==2?"selected":"";?>>普通</option>
						  </select>
									...
									<table aria-describedby="dataTables-example_info" role="grid" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
										<thead>
											<tr role="row">
												...
												<th aria-label="Engine version: activate to sort column ascending" style="text-align:center" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">置顶状态</th>
												<th aria-label="Engine version: activate to sort column ascending" style="text-align:center" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">浏览状态</th>
										...
										<tbody>
											...
											<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr role="row" class="gradeA odd"  style="text-align:center">
													<td class=""><?php echo ($vo['id']); ?></td>
													<td class="sorting_1"><?php echo (msubstr($vo['title'],0,7,'utf-8',true)); ?></td>
													<td><?php echo ($vo['username']); ?></td>
													<td><?php echo date('Y-m-d H:i:s',$vo['ctime']);?></td>
													<td>
														<?php if($vo['state1'] == 1): ?>已置顶
													...
													<td class="center">
														<a href="<?php echo U('Lpost/pdetail',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs">查看详情</a>




														<a href="<?php echo U('Lpost/top',array('id'=>$vo['id'],'state1'=>$vo['state1']));?>" class="btn btn-success btn-xs">
															<?php if($vo['state1'] == 2): ?>置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;顶
															<?php else: ?>取消置顶<?php endif; ?>
														</a>
														<a href="<?php echo U('Lpost/hot',array('id'=>$vo['id'],'hot'=>$vo['hot']));?>" class="btn btn-success btn-xs">
															<?php if($vo['hot'] == 2): ?>加为热帖
															<?php else: ?>取消热帖<?php endif; ?>
														</a>
														<input type="hidden" class="inp" value="<?php echo ($vo['id']); ?>">
														<a href="<?php echo U('Lpost/toRecycle',array('id'=>$vo['id']));?>" class="rec btn btn-warning btn-xs">加入回收站</a>
													</td>
