                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <form style="border:0;">
                                            <tr style="border-top:0;">
                                                <th  style="border-top:0;" class="text-center" colspan="8">
                                                商品名称:
                                                <span style="padding:0 10px;">
                                                    <input type="text" value="<?php echo I('get.pname');?>" name="pname" style="width:150px"/>
                                                 </span>
                                                 <span style="padding:0 10px;" style="display:none;">
                                                   <input style="width:150px;display:none;" value="<?php echo I('get.addtime');?>" type="text" name="addtime" value="<?php echo I('get.addtime');?>" onClick="WdatePicker('Y-m-d H:i:s')">
                                                 </span>

                                                 <span style="padding:0 10px;">

                                                   <span>最低价格：</span><input type="text" name="start" value="<?php echo I('get.start');?>" style="width:50px;"/>
                                                   <span style="margin-left: 15px;">最高价格：</span><input type="text" name="end" value="<?php echo I('get.end');?>" style="width:50px;"/>
                                                 </span>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">轴距</th>
                                            <th class="text-center">最大马力</th>
                                            <th class="text-center">公告型号</th>
                                    ...
                                    <tbody>
										...
										<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
	                                            ...
	                                            <td style="vertical-align:middle;" class="jiequ"><a href="<?php echo U('Xproduct/edit',array('id'=>$vo['id']));?>"><?php echo (msubstr($vo['pname'],0,10,'utf-8',true)); ?></a></td>
	                                            <td style="vertical-align:middle;"><?php echo ($vo['price']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['wheelbase']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['horsepower']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['announcement']); ?></td>
	                                            <td>
	                                               <img src="<?php echo ($vo['picname']); ?>" height="50px"/>
	                                            </td>
	                                            <td style="vertical-align:middle;">
	                                            <a href="<?php echo U('Xproduct/edit',array('id'=>$vo['id']));?>" class="btn btn-primary">编辑</a>
	                                             <a href="<?php echo U('Xproduct/delete',array('id'=>$vo['id']));?>" class="btn btn-danger">删除</a>

	                                            </td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>

										<tr>
											<td colspan="8" class="text-center"><?php echo ($show); ?></td>
