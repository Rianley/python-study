							...
							<div class="row">
								<div class="col-sm-12">
									<table aria-describedby="dataTables-example_info" role="grid" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
										<thead>
											<tr role="row">
												<th aria-label="Rendering engine: activate to sort column ascending" style="width: 175px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">链接id</th>
												<th aria-sort="descending" aria-label="Browser: activate to sort column ascending" style="width: 203px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting_desc">链接名称</th>
												<th aria-label="Platform(s): activate to sort column ascending" style="width: 184px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">链接地址</th>
												<th aria-label="CSS grade: activate to sort column ascending" style="width: 108px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">操作</th>
											</tr>
										</thead>
										<tbody>
											...
											<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr role="row" class="gradeA odd">
													<td class=""><?php echo ($vo['id']); ?></td>
													<td class="sorting_1"><?php echo ($vo['aname']); ?></td>
													<td><?php echo ($vo['address']); ?></td>
													<td class="center">
														<a href="<?php echo U('Link/edit',array('id'=>$vo['id']));?>" class="btn btn-warning btn-xs">修改</a>
														<a href="<?php echo U('Link/delete',array('id'=>$vo['id']));?>" class="btn btn-danger btn-xs">删除</a>
								...
								<div class="col-sm-12 ">
									<div id="dataTables-example_paginate" class="dataTables_paginate paging_simple_numbers">
										...
										<!-- <ul class="pagination">
											...
											<li tabindex="0" aria-controls="dataTables-example" class="paginate_button ">
												<a href="#">1</a>
											</li>
											<li tabindex="0" aria-controls="dataTables-example" class="paginate_button ">
												<a href="#">2</a>
											...
											<li id="dataTables-example_next" tabindex="0" aria-controls="dataTables-example" class="paginate_button next disabled">
												<a href="#">Next</a>
											</li>
										</ul> -->
									</div>
