		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('Xarticlecate/insert');?>" method="post">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">父类别名：</label>
									<div class="col-sm-10">
										<?php echo I('get.name',"根目录");?>

										<input type="hidden" id="pid"  name="pid"  value="<?php echo I('get.id');?>">
