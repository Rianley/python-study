	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">轮播修改页</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('Lunbo/update');?>" method="post"  enctype="multipart/form-data">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">轮播标题</label>
									<div class="col-sm-10">
										<input type="hidden" name="id" value="<?php echo ($res['id']); ?>">
										<input type="text" class="form-control" id="title" placeholder="轮播标题" value="<?php echo ($res['title']); ?>" name="title">
									</div>
								</div>
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">轮播地址</label>
									<div class="col-sm-10">
										<input type="radio" name="state" value="1" <?php if($res['state'] == 1): ?>checked<?php endif; ?>>论坛
										<input type="radio" name="state" value="2" <?php if($res['state'] == 2): ?>checked<?php endif; ?>>商城
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="file" id="pic" placeholder="轮播图片" name="pic" value="/threeall/ThinkPHP/Public/<?php echo ($res['pic']); ?>">
									</div>
								</div>
								<div class="form-group">
