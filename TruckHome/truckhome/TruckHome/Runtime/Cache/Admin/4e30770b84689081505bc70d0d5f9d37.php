		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('Xproduct/insert');?>" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">产品名称：</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" style="width:50%" id="pname" placeholder="产品名称：" name="pname"></div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">价格:</label>
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="price" placeholder="价格" name="price">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">车身长度:</label>
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="boxlength" placeholder="车身长度" name="boxlength">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">轴距:</label>
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="wheelbase" placeholder="轴距" name="wheelbase">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">前进档位:</label>
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="forwardgear" placeholder="前进档位" name="forwardgear">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="horsepower" placeholder="最大马力" name="horsepower">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">发动机:</label>
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="engine" placeholder="发动机" name="engine">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">排放标准:</label>
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="effluent" placeholder="排放标准" name="effluent">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">公告型号:</label>
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="announcement" placeholder="公告型号" name="announcement">
									</div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">驱动形式:</label>
									<div class="col-sm-10">
										<input style="width:50%" type="text" class="form-control" id="drive" placeholder="驱动形式" name="drive">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select style="width:50%" class="form-control" name="tid">
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(in_array($vo['id'],$pid)): ?><option value="<?php echo ($vo['id']); ?>" disabled style="padding-left:<?php echo ($vo['level']*50); ?>px;">
													<?php echo str_repeat("&nbsp;",$vo['level']*5);?>|--<?php echo ($vo['name']); ?>
												</option>
												<?php else: ?>
												<option value="<?php echo ($vo['id']); ?>"  style="padding-left:<?php echo ($vo['level']*50); ?>px;">
													<?php echo str_repeat("&nbsp;",$vo['level']*5);?>|--<?php echo ($vo['name']); ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<!-- <textarea  style="width:50%" class="form-control" rows="5" id="wysiwig_full" name="describes"></textarea> -->
