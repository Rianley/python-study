...
<!-- <link rel="stylesheet" type="text/css" href="/threeall/ThinkPHP/Public/page/css.css" media="all" /> -->
	<div class="row">
		 <div class="col-lg-12">
                            ...
                            <div class="table-responsive table-bordered">
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        ...
                                        <input type="checkbox" id="checkall" value="">全选
                                            ...
                                            <th class="text-center">意向车型</th>
                                            <th class="text-center">提车地区</th>
                                    ...
                                    <tbody class="vocheck">
										...
										<?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-center " >
                                                <td  style="vertical-align:middle;">


                                                        <input type="checkbox" id="check<?php echo ($k); ?>" value="<?php echo ($vo['id']); ?>" aria-label="..." name="ckvalue<?php echo ($k); ?>">

                                                </td>

	                                            <td style="vertical-align:middle;"><?php echo ($vo['id']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo (msubstr($vo['pname'],0,16,'utf-8',true)); ?></td>
	                                            <td style="vertical-align:middle;"><?php echo ($vo['address']); ?></td>
	                                            <td style="vertical-align:middle;"><?php echo ($vo['name']); ?></td>
	                                            <td style="vertical-align:middle;"><?php echo ($vo['sex']==1?"男":"女"); ?></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['phone']); ?></td>
	                                            <td style="vertical-align:middle;"><?php echo date("Y-m-d",$vo['addtime']);?></td>
	                                            <td style="vertical-align:middle;">
	                                               <a href="<?php echo U('Xchaprice/detail',array('id'=>$vo['id']));?>" class="btn btn-primary">查看详情</a>
                                                   <a href="<?php echo U('Xchaprice/delete',array('id'=>$vo['id']));?>" class="btn btn-danger">删除</a>
	                                               <!-- <a href="<?php echo U('Xchaprice/daochu',array('id'=>$vo['id']));?>">到处表格</a> -->
                                        ...
                                        <tr>
                                            ...
                                            <a class="btn btn-danger" href="javascript:;" id="delbtn"/>批量删除</a>

                                            <a  class="btn btn-success" id="exportbtn" href="<?php echo U('Xchaprice/exprotExcel');?>">导出数据备份</a>


                                               <!--  <input type="submit" class="btn btn-danger" value="批量删除"/>

                                                <input type="submit"  class="btn btn-success" value="导出表格"/> -->
                                ...
                                $(function(){
                                    ...
                                    $('#delbtn').click(function(){
                                        ...
                                        var params = arr.join(',');
                                        //console.log(params);
                                        $.post("<?php echo U('Xchaprice/betchDel');?>",'params='+params,function(msg){
                                            if(msg=="ok"){
                                                alert("删除成功了");
                                    ...
                                    //     var params = arr.join(',');
                                    //     console.log(params);
                                    //     $.get("<?php echo U('Xchaprice/exprotExcel');?>",'params='+params,function(msg){
                                    //         console.log(msg);
                                    //         if(msg!=null){
                                    //             alert("导出成功了");
                                    //             // window.location.reload();
