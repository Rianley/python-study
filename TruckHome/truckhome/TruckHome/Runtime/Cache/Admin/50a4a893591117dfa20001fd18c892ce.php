		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('Link/update');?>"  method="post">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">链接名：</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="aname" placeholder="链接名" name="aname"  value="<?php echo ($data['aname']); ?>">

										<input type="hidden" class="form-control" id="id" placeholder="链接名" name="id"  value="<?php echo ($data['id']); ?>"></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="address" name="address" placeholder="链接地址" value="<?php echo ($data['address']); ?>"></div>
								</div>
								<div class="form-group">
