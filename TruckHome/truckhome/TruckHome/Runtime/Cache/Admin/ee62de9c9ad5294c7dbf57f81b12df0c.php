...
<style>
	...
	<div class="row">
		...
		<div style="margin-left:15px">
			<form method="get" action="<?php echo U('Sorder/index');?>">
				<input type="text" name="id" placeholder="请输入订单号">
				<select name="state">
					<option value="">--请选择--</option>
					<option value="1" <?php echo I('get.state')==1?"selected":"";?>>待付款</option>
					<option value="2" <?php echo I('get.state')==2?"selected":"";?>>待收货</option>
					<option value="3" <?php echo I('get.state')==3?"selected":"";?>>已收货</option>
					<option value="4" <?php echo I('get.state')==4?"selected":"";?>>发货</option>
				</select>
						...
						<table class="table table-striped table-bordered table-hover  text-center" >
							...
							<tbody>
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
										...
										<td>
											<?php if($vo['state'] == 4): ?><a href="<?php echo U('Sorder/deliver',array('id'=>$vo['id']));?>" class="btn btn-warning btn-xs">去发货</a><?php endif; ?>
											<a href="<?php echo U('Sorder/orderDetail',array('id'=>$vo['id']));?>" class="btn btn-warning btn-xs">查看详情</a>
