		...
		<div class="col-lg-12">
			<div class="panel panel-defauslt">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form role="form" class="form-horizontal" method="post" action="<?php echo U('Lnotic/update');?>">
								<div class="form-group">
									<label class="col-sm-1">标题</label>
									<div class="col-sm-6">
										<input class="form-control" name="title" placeholder="请输入标题名" value="<?php echo ($data['title']); ?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<script id="editor" name="content" type="text/plain" style="width:700px;height:400px;"><?php echo htmlspecialchars_decode($data['content']);?></script>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										...
										<button class="btn btn-primary  btn-sm" onclick="javascript:location.href='<?php echo U('Lnotic/index');?>';" class="btn btn-default" type="button">取消</button>
									</div>
								</div>
							</form>
						</div>
