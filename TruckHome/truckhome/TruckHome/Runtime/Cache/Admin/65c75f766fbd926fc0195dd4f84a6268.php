	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">回收站管理</div>
				<!-- /.panel-heading -->
						...
						<table class="table table-striped table-bordered table-hover  text-center" >
							...
							<tbody>
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
										...
										<td><?php echo (msubstr($vo['proname'],0,30,'utf-8',true)); ?></td>
										<td><img src="/threeall/ThinkPHP/Public/shop/<?php echo ($vo['image']); ?>"/></td>
										<td><?php echo ($vo['price']); ?></td>
										<td><?php echo ($vo['storage']); ?></td>
										<td><?php echo ($vo['salenum']); ?></td>

										<td>
											<?php if($vo['discount'] == 1): ?>无折扣
											<?php else: ?>
												<?php echo ($vo['discount']*10); ?>折<?php endif; ?>
										</td>
										<td>
											<a href="<?php echo U('Sproduct/del',array('id'=>$vo['id']));?>" class="btn btn-danger btn-xs ">&nbsp;        彻底删除</a>
											<a href="<?php echo U('Sproduct/detail',array('id'=>$vo['id']));?>" class="btn btn-warning btn-xs">查看详情</a>
											<a href="<?php echo U('Sproduct/outRecycle',array('id'=>$vo['id']));?>" class="btn btn-warning btn-xs">
											恢复
											</a>
										</td>
							...
							<tr>
								<td colspan="12" class="text-right"><?php echo ($show); ?></td>
							</tr>
						</table>
					</div>
					<!-- /.table-responsive -->
