		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('Xprodimg/update');?>" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">产品名称:</label>
									<div class="col-sm-10">

										<select style="width:50%" class="form-control" name="pid">
											<?php if(is_array($prod)): $i = 0; $__LIST__ = $prod;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php echo ($vo['id']==$poneid?'selected':''); ?>>
													<?php echo ($vo['pname']); ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<label class="radio-inline">
											<input type="hidden" name="id" value="<?php echo ($data['id']); ?>"/>
											<input type="radio" name="state" id="state" <?php echo ($data['state']==1?"checked":""); ?> value="<?php echo ($data['state']); ?>"/>外观
										</label>
										<label class="radio-inline">
											<input type="radio" name="state" id="state" value="<?php echo ($data['state']); ?>" <?php echo ($data['state']==2?"checked":""); ?>/>驾驶室
										</label>
										<label class="radio-inline">
											<input type="radio" name="state" id="state" value="<?php echo ($data['state']); ?>" <?php echo ($data['state']==3?"checked":""); ?> />底盘
										</label>
									</div>
								</div>
								...
								<div class="form-group">
    								...
    								<div class="col-sm-10">
										...
										<img src="<?php echo ($data['picname']); ?>"  height="80px"/>
    								</div>
  								</div>
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										...
										<button onclick="javascript:location.href='<?php echo U('Xprodimg/index');?>';" class="btn btn-primary" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
									</div>
								</div>
							</form>
						</div>
