		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('Xarticle/update');?>" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">标题：</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" value="<?php echo ($data['title']); ?>" style="width:50%" id="title" placeholder="标题" name="title">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" value="<?php echo ($data['author']); ?>" class="form-control" style="width:50%" id="author" placeholder="作者" name="author"></div>
								</div>
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">编辑：</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" style="width:50%" id="editor" placeholder="编辑" name="editor" value="<?php echo ($data['editor']); ?>"></div>
								</div>
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">文章分类:</label>
									<div class="col-sm-10">
										<select style="width:50%" class="form-control" name="atype">
                                                <option value="1" <?php echo ($data['atype']==1?"selected":""); ?>>原创</option>
                                                <option value="2" <?php echo ($data['atype']==2?"selected":""); ?>>转载</option>
                                        </select>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" style="width:50%" id="origin" placeholder="来源" value="<?php echo ($data['origin']); ?>" name="origin"></div>
								</div>

									<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">热点新闻：</label>
									<div class="col-sm-10">

										<label class="radio-inline">
											<input type="radio" name="hot" <?php echo ($data['hot']==1?"checked":""); ?> id="hot" value="1" />普通新闻
										</label>
										<label class="radio-inline">
											<input type="radio" name="hot" id="hot" value="2" <?php echo ($data['hot']==2?"checked":""); ?>/>热点新闻
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-2 control-label">文章分类:</label>
									<div class="col-sm-10">
										<select style="width:50%" class="form-control" name="acid">
                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php echo ($vo['id']==$data['acid']?"selected":""); ?>><?php echo str_repeat("&nbsp;",$vo['level']*5);?>|--<?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select style="width:50%" class="form-control" name="vid">
											<?php if(is_array($listc)): $i = 0; $__LIST__ = $listc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(in_array($vo['id'],$pidc)): ?><option value="<?php echo ($vo['id']); ?>" <?php echo ($vo['id']==$data['vid']?"selected":""); ?> disabled style="padding-left:<?php echo ($vo['level']*50); ?>px;">
													<?php echo str_repeat("&nbsp;",$vo['level']*5);?>|--<?php echo ($vo['name']); ?>
												</option>
												<?php else: ?>
												<option value="<?php echo ($vo['id']); ?>" <?php echo ($vo['id']==$data['vid']?"selected":""); ?> style="padding-left:<?php echo ($vo['level']*50); ?>px;">
													<?php echo str_repeat("&nbsp;",$vo['level']*5);?>|--<?php echo ($vo['name']); ?>
								...
								<div class="form-group">
    								...
    								<div class="col-sm-10">
										...
										<img src="<?php echo ($data['picname']); ?>"  height="60px"/>
    								</div>
  								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										...
										<button onclick="javascript:location.href='<?php echo U('Xarticle/index');?>';" class="btn btn-primary" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
									</div>
								</div>
							</form>
						</div>
