                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <form style="border:0;">
                                            <tr style="border-top:0;">
                                                <th  style="border-top:0;" class="text-center" colspan="5">
                                                商品名称:
                                                <span style="padding:0 10px;">
                                                    <input type="text" value="<?php echo I('get.pname');?>" name="pname" style="width:150px"/>
                                                 </span>
                                                 <span style="padding:0 10px;">
                                                    添加日期:<input style="width:150px;" value="<?php echo I('get.addtime');?>" type="text" name="addtime" value="<?php echo I('get.addtime');?>" onClick="WdatePicker({dateFmt:'yyyy年MM月dd日 HH时mm分ss秒'})">
                                                 </span>
                                    ...
                                    <tbody>
										...
										<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
	                                            ...
	                                            <td style="vertical-align:middle;" class="jiequ"><a href="<?php echo U('Xprodimg/edit',array('id'=>$vo['id']));?>"><?php echo (msubstr($vo['pname'],0,10,'utf-8',true)); ?></a></td>
	                                            <td>
	                                            ...
	                                            <a href="<?php echo U('Xprodimg/edit',array('id'=>$vo['id']));?>" class="btn btn-primary">编辑</a>
	                                             <a href="<?php echo U('Xprodimg/delete',array('id'=>$vo['id']));?>" class="btn btn-danger">删除</a>

	                                            </td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>

										<tr>
											<td colspan="5" class="text-center"><?php echo ($show); ?></td>
