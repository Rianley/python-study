		...
		<div class="col-lg-12">
			<div class="panel panel-defauslt">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form role="form" class="form-horizontal" method="post" action="<?php echo U('Scategory/insert');?>" enctype="multipart/form-data">
								<div class="form-group">
									<input type="hidden" name="pid" value="<?php echo I('get.id');?>">
									<label class="col-sm-1">类名</label>
									<div class="col-sm-6">
										<input class="form-control" name="catename" placeholder="请输入子类名">
									</div>
								</div>
