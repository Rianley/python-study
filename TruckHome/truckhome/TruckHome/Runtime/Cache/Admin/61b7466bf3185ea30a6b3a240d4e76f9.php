...
<body>
 ...
 <ul class="nav navbar-top-links navbar-right">
	...
	<script src="/threeall/ThinkPHP/Public/admin/dist/js/area.js"></script>
	<div class="row">
		<div class="col-lg-12">
						...
						<div class="col-lg-12">
							<form class="form-horizontal" action="<?php echo U('User/update');?>"  method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="username" placeholder="用户名" name="username"  value="<?php echo ($data['username']); ?>">

										<input type="hidden" class="form-control" id="id" placeholder="用户名" name="id"  value="<?php echo ($data['id']); ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="phone" placeholder="电话" name="phone"  value="<?php echo ($data['phone']); ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="email" placeholder="邮箱" name="email"  value="<?php echo ($data['email']); ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<label class="radio-inline">
											<input type="radio" name="sex" id="sex" value="1" <?php echo ($data['sex']==1?'checked':''); ?>/>男
										</label>
										<label class="radio-inline">
											<input type="radio" name="sex" id="sex" value="2" <?php echo ($data['sex']==2?'checked':''); ?>/>女
										</label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<label class="radio-inline">
											<input type="radio" name="state" id="state" value="1" <?php echo ($data['state']==1?'checked':''); ?>/>启用
										</label>
										<label class="radio-inline">
											<input type="radio" name="state" id="state" value="2" <?php echo ($data['state']==2?'checked':''); ?>/>禁用
										</label>
									</div>
								</div>
								<div class="form-group">
