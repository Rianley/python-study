                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
										...
										<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
	                                            ...
	                                            <td style="vertical-align:middle;"><a href="<?php echo U('Xarticle/edit',array('id'=>$vo['id']));?>"><?php echo (msubstr($vo["title"],0,10,'utf-8',true)); ?></a></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['atype']=="1"?"原创":"转载"); ?></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['origin']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['name']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['author']); ?></td>
                                                <td style="vertical-align:middle;"><?php echo ($vo['editor']); ?></td>
	                                            ...
	                                            <td style="vertical-align:middle;">
                                                     <a href="<?php echo U('Xarticle/updatetage',array('id'=>$vo['id'],'tage'=>$vo['tage']));?>" class="btn btn-success">
                                                        <?php if($vo['tage'] == 1): ?>取消置顶
                                                        <?php else: ?>
                                                            置顶<?php endif; ?>
                                                     </a>

	                                               <a href="<?php echo U('Xarticle/edit',array('id'=>$vo['id']));?>" class="btn btn-primary">编辑</a>
	                                               <a href="<?php echo U('Xarticle/updatestate',array('id'=>$vo['id'],'state'=>$vo['state']));?>" class="btn btn-info">
                                                        回收站
                                                     </a>
                                                   <a href="<?php echo U('Xarticle/delete',array('id'=>$vo['id']));?>" class="btn btn-danger">删除</a>

	                                            </td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>

										<tr>
											<td colspan="9" class="text-center"><?php echo ($show); ?></td>
