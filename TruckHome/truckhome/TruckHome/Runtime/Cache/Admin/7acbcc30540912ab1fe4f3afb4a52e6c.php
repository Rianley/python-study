...
<body>
 ...
 <ul class="nav navbar-top-links navbar-right">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-defauslt">
				<div class="panel-heading">修改商品</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form role="form" class="form-horizontal" method="post" action="<?php echo U('Sproduct/update');?>" enctype="multipart/form-data">
							<input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
								<div class="form-group">
									<label class="col-sm-1">商品名</label>
									<div class="col-sm-6">
										<input class="form-control" name="proname" value="<?php echo ($data['proname']); ?>">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<select name="cid">
											...
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>"  style="text-indent: <?php echo ($vo['level']*30); ?>px" <?php echo ($vo['id']==$data['cid'] ? 'selected disabled' : ''); ?> <?php echo ($vo['childs'] ? 'disabled' : ''); ?>>
								...
								<div class="form-group">
									...
									<img  class="col-sm-3"src="/threeall/ThinkPHP/Public/shop/<?php echo ($data['image']); ?>">
									<div class="col-sm-6">
								...
								<div class="form-group">
									<label class="col-sm-1">库存</label>
									<div class="col-sm-6">
										<input class="form-control" name="storage" value="<?php echo ($data['storage']); ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input class="form-control" name="brand" value="<?php echo ($data['brand']); ?>">
									</div>
								...
								<div class="form-group">
									...
									<input type="checkbox" name="hot" id="sex"  <?php echo ($data['hot']==1?'checked':''); ?>> 热卖</label>
									<label class="radio-inline">
									<input type="checkbox" name="new" id="sex"  <?php echo ($data['new']==1?'checked':''); ?>>新品</label>
									<label class="radio-inline">
									<input type="checkbox" name="promotion" id="sex"  <?php echo ($data['promotion']==1?'checked':''); ?>>促销</label>

								</div>
								<div class="form-group">
									<label class="col-sm-1">折扣</label>
									<div class="col-sm-6">
										<input class="form-control" name="discount" value="<?php echo ($data['discount']); ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<script id="editor" name="description" type="text/plain" style="width:800px;height:500px;"><?php echo htmlspecialchars_decode($data['description']);?></script>
									</div>
								</div>
	...
	<script>
		// 初始化编辑器
		 ...
		 var ue = UE.getEditor('editor1',{
		 	toolbars: [
			    [ 'undo','redo','cleardoc','simpleupload','insertimage'],
