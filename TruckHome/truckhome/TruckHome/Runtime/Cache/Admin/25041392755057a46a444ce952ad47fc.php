...
<!-- <link rel="stylesheet" type="text/css" href="/TruckHome/truckhome/Public/page/css.css" media="all" /> -->
	<div class="row">
		 <div class="col-lg-12">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
										...
										<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-center">
	                                            ...
	                                            <td style="vertical-align:middle;"><a href="<?php echo U('User/edit',array('id'=>$vo['id']));?>"><?php echo ($vo['username']); ?></a></td>
	                                            ...
	                                            <!-- <td style="vertical-align:middle;"><?php echo ($vo['cate']==1?"管理员":"普通会员"); ?></td> -->
	                                            <td style="vertical-align:middle;"><?php echo ($vo['state']==1?"启用":"禁用"); ?></td>
	                                            <td style="vertical-align:middle;">
	                                            <a href="<?php echo U('User/edit',array('id'=>$vo['id']));?>">编辑</a>
                                                 <a href="<?php echo U('User/able',array('id'=>$vo['id'],'state'=>$vo['state']));?>"><?php if($vo['state'] == 2): ?>启用
                                                            <?php else: ?>禁用<?php endif; ?></a>
