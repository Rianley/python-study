                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover  text-center" >
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td>商品图片</td>
                                        <td><img style="border:1px solid #ccc"src="/threeall/ThinkPHP/Public/shop/<?php echo ($data['image']); ?>"/></td>
                                    </tr>
                                    <tr>
                                        <td>商品类别</td>
                                        <td><?php echo ($data['catename']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>品牌</td>
                                    ...
                                    <tr>
                                        <td>销量</td>
                                        <td><?php echo ($data['salenum']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>状态</td>
                                        <td>
                                            <?php echo ($data['hot']?'热卖':''); ?>
                                            <?php echo ($data['promotion']?'促销':''); ?>
                                            <?php echo ($data['new']?'新品':''); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>折扣</td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <a href="<?php echo U('Sproduct/edit',array('id'=>$data['id']));?>" class="btn btn-warning btn-xs ">修改</a>

                                            <a href="<?php echo U('Sproduct/toRecycle',array('id'=>$data['id']));?>" class="btn btn-danger btn-xs">放入回收站</a>
                                        </td>
                                    </tr>
