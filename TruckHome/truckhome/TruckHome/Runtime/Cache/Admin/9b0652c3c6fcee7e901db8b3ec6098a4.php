...
<style>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div>
			<form method="get" action="<?php echo U('Sproduct/index');?>">
				<input type="text" name="proname" placeholder="请输入商品名">
						...
						<table class="table table-striped table-bordered table-hover  text-center" >
							...
							<tbody>
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
										...
										<td>
											<a href="<?php echo U('Sproduct/edit',array('id'=>$vo['id']));?>" class="btn btn-warning btn-xs ">修改</a>
											<a href="<?php echo U('Sproduct/detail',array('id'=>$vo['id']));?>" class="btn btn-warning btn-xs">查看详情</a>
											<a href="<?php echo U('Sproduct/toRecycle',array('id'=>$vo['id']));?>" class="btn btn-danger btn-xs">放入回收站</a>
										</td>
